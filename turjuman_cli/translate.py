...
def get_parser():
    ...
    parser.add_argument('-s', '--seq_length', type=int, help='The maximum sequence length value, default vlaue is 512')
    ...
    parser.add_argument('-l', '--logging_file', default="./turjuman_translate_cli.log", type=str, help='The logging file path, default vlaue is turjuman_translate_cli.log')
